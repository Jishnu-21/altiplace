  ...
  return (
    <section className="relative bg-black">
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        <motion.div 
          className="relative w-full max-w-[1400px] mx-auto border border-[#1a2e35] rounded-lg overflow-hidden"
          initial="hidden"
          animate="visible"
        ...
        >
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 p-4 sm:p-6 md:p-8">
            ...
            <motion.div 
              className="md:w-1/2 space-y-3 sm:space-y-4 pr-1 sm:pr-2 pb-4"
              variants={itemVariants}
            >
